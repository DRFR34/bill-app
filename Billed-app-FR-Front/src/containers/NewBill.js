...
export default class NewBill {
  ...
  handleChangeFile = e => {
    ...
    //* "disabled" will be used in the file format condition 
    button.disabled = false;
    //* condition of file extension for creating a newbill 
    /* istanbul ignore if */
    if (extension === ".jpg" || extension === ".jpeg" || extension === ".png") {
      ...
      Object.assign(wrongFileTypeErrorMsg.style, {
        display: "block",
        color: "red",
        fontWeight: "bold"
      });
